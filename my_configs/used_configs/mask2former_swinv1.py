...
launcher = 'none'
load_from = 'Skinet/Projet/Data/checkpoints/mask2former_swin-s-p4-w7-224_8xb2-lsj-50e_coco_20220504_001756-c9d0c4f2.pth'
...
test_evaluator = dict(
    ann_file=
    'Skinet/Projet/Data/Datasets/skinet_dataset/inflammation/test/labels.json',
    format_only=False,
    metric=[
        'bbox',
        'segm',
...
work_dir = 'Skinet/Projet/exps/mask2former_swin_s_alldata/step1/inflammation'
